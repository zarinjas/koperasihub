            ...
            <form @submit.prevent="submit" class="space-y-6">
                <div class="grid gap-6 xl:grid-cols-[1fr_1.5fr]">
                    <div class="space-y-4">
                        ...
                        <div
                            class="relative flex aspect-[4/1] w-full items-center justify-center overflow-hidden rounded-2xl border-2 border-dashed transition-colors"
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                type="url"
                                class="h-11 w-full rounded-lg border border-slate-300 px-3 text-sm focus:border-teal-500 focus:outline-none focus:ring-1 focus:ring-teal-500"
                                placeholder="https://koperasi.my/halaman-sasaran"
                            />
                            <p v-if="form.errors.link_url" class="mt-1 text-sm text-red-600">{{ form.errors.link_url }}</p>
                            <p class="mt-1 text-xs text-slate-400">Ahli akan diarahkan ke URL ini apabila mengklik banner.</p>
                        </div>
