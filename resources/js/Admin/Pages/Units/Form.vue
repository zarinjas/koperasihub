...
<template>
    <Head :title="isEdit ? 'Edit Unit' : 'Tambah Unit'" />

    <AdminLayout>
        <section class="space-y-6">
            <PageHeader :title="isEdit ? 'Edit Unit' : 'Tambah Unit'" :description="isEdit ? 'Kemas kini maklumat unit.' : 'Tambah unit atau bahagian baharu.'">
                <template #actions>
                    <Button :as="Link" href="/admin/units" variant="outline">Kembali</Button>
                </template>
            </PageHeader>
            ...
            <div class="flex justify-end gap-3">
                <Button :as="Link" href="/admin/units" variant="outline">Batal</Button>
