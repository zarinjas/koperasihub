...
const search = () => router.get('/member/forms', filters, { preserveState: true, replace: true });
</script>
...
<template>
    ...
    <MemberLayout>
        <section class="space-y-6">
            <PageHeader
                title="Borang"
                description="Cari dan isi borang rasmi koperasi secara online mengikut kategori yang tersedia."
            />
            ...
            <section v-else class="space-y-4 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
